...
def get_intelligence_runtime_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "season_agent_llm_enabled": _read_bool_env("INTELLIGENCE_SEASON_AGENT_LLM_ENABLED", True),
        ...
        "prematch_agent_llm_enabled": _read_bool_env("INTELLIGENCE_PREMATCH_AGENT_LLM_ENABLED", True),
        ...
        "career_agent_llm_enabled": _read_bool_env("INTELLIGENCE_CAREER_AGENT_LLM_ENABLED", True),
        ...
        "career_dashboard_ai_enabled": _read_bool_env("INTELLIGENCE_CAREER_DASHBOARD_AI_ENABLED", True),
        "postmatch_agent_llm_enabled": _read_bool_env("INTELLIGENCE_POSTMATCH_AGENT_LLM_ENABLED", True),
        "postmatch_agent_model_profile": str(os.getenv("INTELLIGENCE_POSTMATCH_AGENT_MODEL_PROFILE", "flash")).strip().lower() or "flash",
        "postmatch_agent_max_tools": int(os.getenv("INTELLIGENCE_POSTMATCH_AGENT_MAX_TOOLS", "3")),
        "postmatch_agent_model_retries": int(os.getenv("INTELLIGENCE_POSTMATCH_AGENT_MODEL_RETRIES", "1")),
        "postmatch_agent_retry_delay_seconds": float(os.getenv("INTELLIGENCE_POSTMATCH_AGENT_RETRY_DELAY_SECONDS", "0.35")),
